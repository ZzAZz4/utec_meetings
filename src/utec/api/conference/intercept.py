from src.utec.core.driver import WiredWebdriver
...
def intercept_request_content(driver: WiredWebdriver, start, end, progress: ProgressIndicator) -> list[dict[str, Any]]:
